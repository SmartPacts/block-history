...
// consecutive blocks) and 205 gas per recorded block (measured on devnet). A redundant feeder's
// losing attests cost ~150 gas, so for a second feeder this errs on the long side.
//
